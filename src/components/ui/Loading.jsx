    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-12 px-4">
            <div className="relative flex items-center justify-center">
                ...
                <div className="absolute w-16 h-16 rounded-full bg-linear-to-tr from-purple-600 via-indigo-600 to-blue-500 opacity-20 blur-md animate-pulse"></div>
                
                {/* Double-layered rotating premium spinner */}
            ...
            {/* Pulsing Loading Text with gradient accent */}
