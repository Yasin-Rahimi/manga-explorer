...
export default function ImageUploader() {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto px-3 py-3 sm:px-4 sm:py-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm shadow-xl">
            <div className="flex items-center gap-2 mb-2">
                <FaSearch className="text-purple-400 text-lg sm:text-2xl" />
                <h2 className="text-lg sm:text-2xl font-bold text-white">Search Manga by Image</h2>
            </div>
            <p className="text-gray-300 text-xs sm:text-sm mb-3 sm:mb-6 flex items-start gap-1">
            ...
            <p className="text-xs text-gray-500 mt-4 sm:mt-6 text-left flex items-start justify-center gap-2">
