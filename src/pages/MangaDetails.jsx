          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-3 gap-3 max-w-md mx-auto lg:mx-0">
              ...
              <div className="bg-white/5 border border-white/5 rounded-xl p-3 text-center backdrop-blur-md transition hover:bg-white/10">
                <span className="block text-amber-400 text-xl font-bold mb-1">
                  ⭐ {manga.score ?? "N/A"}
                </span>
              ...
              {/* Rank Card */}
              <div className="bg-white/5 border border-white/5 rounded-xl p-3 text-center backdrop-blur-md transition hover:bg-white/10">
                <span className="block text-purple-400 text-xl font-bold mb-1">
                  #{manga.rank ?? "N/A"}
                </span>
                <span className="text-[10px] text-gray-400 uppercase tracking-widest font-semibold">
                  Global Rank
              ...
              {/* Popularity Card */}
              <div className="bg-white/5 border border-white/5 rounded-xl p-3 text-center backdrop-blur-md transition hover:bg-white/10">
                <span className="block text-pink-400 text-xl font-bold mb-1">
