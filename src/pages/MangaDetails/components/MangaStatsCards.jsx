...
export default function MangaStatsCards({ score, rank, popularity }) {
    return (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full max-w-full sm:max-w-2xl mx-auto lg:mx-0">
            <div className="bg-white/5 border border-white/5 rounded-xl p-3 sm:p-4 text-center backdrop-blur-md transition flex flex-col items-center justify-between hover:bg-white/10">
                <span className="flex items-center justify-center gap-1 text-lg sm:text-xl text-amber-400 font-bold mb-1">
